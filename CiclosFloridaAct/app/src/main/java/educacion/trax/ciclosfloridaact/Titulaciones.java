 ...
 * {@link Titulaciones.OnFragmentInteractionListener} interface
...
public class Titulaciones extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final Button inf=v.findViewById(R.id.inf);
    ...
    public void onClick(View v) {
        if (v.getId()==R.id.empresa){
            mListener.empresaListener();
        }
        if (v.getId()==R.id.inf){
            mListener.infListener();
        }
        if (v.getId()==R.id.esports){
            mListener.esportsListener();
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void empresaListener();
        void infListener();
        void esportsListener();
    }
}
